// Base on Tubular
/* jQuery ST Youtube plugin Base on Tubular 
|* by Dannie
...
;(function ($, window) {
    ...
    var tubular = function(node, options) { // should be called on the wrapper div
        ...
        options.appendObj=$(node).data('append');

        options.videoUrl=$(node).data('videourl');

        if(options.videoUrl)
        {
        	options.videoId=getYTPVideoID(options.videoUrl);
        }    
        ...
        $(options.appendObj).prepend(tubularContainer);
